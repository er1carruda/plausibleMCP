...
export const toolDef = {
    ...
    description: "Execute an arbitrary Plausible Stats API v2 query. Use this for advanced analysis not covered by the other tools. See Plausible API v2 docs for full query syntax.",
    schema: {
        metrics: z
            .array(z.string())
    ...
    handler: async (client, params) => {
        const { metrics, date_range, dimensions, filters, order_by, limit, offset, include } = params;
